...
interface TopbarProps {
  ...
  onChatOpen?: () => void;
  admin?: boolean;   // Admin Console pages: org-level, no enterprise selector / move funds / bell / settings
}

export const Topbar: React.FC<TopbarProps> = ({ isLight, onThemeToggle, onChatOpen, admin }) => (
